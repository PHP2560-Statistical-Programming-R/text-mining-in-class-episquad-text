...
Bible_prop<-Bible1 %>% inner_join(get_sentiments("nrc"), by="word") %>% group_by(sentiment) %>% count() %>% mutate(proportion=n/sum(n)) 
#Creat Barplot 
...
Buddhism_prop<-Buddhism1 %>% inner_join(get_sentiments("nrc"), by="word") %>% group_by(sentiment) %>% count() %>% mutate(proportion=n/sum(n)) 
#Creat Barplot 
...
Koran_prop<-Koran1 %>% inner_join(get_sentiments("nrc"), by="word") %>% group_by(sentiment) %>% count() %>% mutate(proportion=n/sum(n))
...
Bible_pn<-Bible1 %>% inner_join(get_sentiments("bing"), by="word") %>% group_by(sentiment) %>% count() %>% mutate(proportion=n/sum(n)) %>% select(sentiment,proportion)
#positive/negative proportion for Buddhism
Buddhism_pn<-Buddhism1 %>% inner_join(get_sentiments("bing"), by="word") %>% group_by(sentiment) %>% count() %>% mutate(proportion=n/sum(n)) %>% select(sentiment,proportion)
#positive/negative proportion for Buddhism
Koran_pn<-Koran1 %>% inner_join(get_sentiments("bing"), by="word") %>% group_by(sentiment) %>% count() %>% mutate(proportion=n/sum(n)) %>% select(sentiment,proportion)
#Combine all books
